...
# data info
UCF_IMAGE_ROOT = 'UCF101-Examples' # <need to specify>
Kinetic_IMAGE_ROOT = 'Kinetics400-Examples' # kinetics dataset path

# save info
# OPT_PATH = 'G:/mycode/CSMA/res-vis-ceshi' # <need to specify>
OPT_PATH = 'res2-patch' # <need to specify>

# checkpoints path for ucf101
UCF_CKPT_PATH = 'ucf_checkpoint' # <need to specify>


def change_cfg(cfg, batch_size, random):
    # modify video paths and pretrain setting.
    cfg.CONFIG.DATA.VAL_DATA_PATH = Kinetic_IMAGE_ROOT
