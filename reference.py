...
def arg_parse():
    ...
    parser.add_argument('--adv_path', type=str, default='D:/code_mine/CLIP-attack/res_clip_ceshi/Image-dino_attack-100-Kinetics-mid', help='the path of adversarial examples.')
