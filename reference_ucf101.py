...
def arg_parse():
    ...
    parser.add_argument('--adv_path', type=str, default='Image-ImageGuidedFML2_Adam_MultiModels-60-ucf101-resnet-adv-self-cross', help='the path of adversarial examples.')
